 ...
 * ```
 */
export declare type DocumentType<T> = (T extends Base<any> ? Omit<mongoose.Document, '_id'> & T : mongoose.Document & T) &
  IObjectWithTypegooseFunction;
/**
 * Used Internally for ModelTypes
 */
export declare type ModelType<T, QueryHelpers = {}> = mongoose.Model<mongoose.Document<T>>;
/**
 ...
 */
export declare type ReturnModelType<U extends AnyParamConstructor<any>, QueryHelpers = {}> = ModelType<InstanceType<U>, QueryHelpers> & U;
