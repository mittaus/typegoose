...
import type { AnyParamConstructor, Func, GetTypeReturn, IObjectWithTypegooseFunction, IObjectWithTypegooseName, IPrototype, KeyStringAny, PropOptionsForNumber, PropOptionsForString, VirtualOptions } from '../types';
 ...
 */
export declare function initProperty(name: string, key: string, whatis: WhatIsIt): mongoose.SchemaDefinition;
/**
 ...
 * @param input
 */
export declare function getClass(input: (mongoose.Document & IObjectWithTypegooseFunction) | (mongoose.Schema.Types.Embedded & IObjectWithTypegooseFunction) | string | IObjectWithTypegooseName | any): NewableFunction | undefined;
/**
 ...
 * @param cl The Class
 */
export declare function getName<U extends AnyParamConstructor<any>>(cl: U): string;
/**
 ...
 */
export declare function mapArrayOptions(rawOptions: any, Type: AnyParamConstructor<any> | mongoose.Schema, target: any, pkey: string, loggerType?: AnyParamConstructor<any>): mongoose.SchemaTypeOpts<any>;
/**
 * Map Options to "inner" & "outer"
 * @param rawOptions The raw options
 * @param Type The Type of the array
